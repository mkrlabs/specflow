...
**Any UI you build — web or native — follows the `mobile-first-contract` skill.**
Read it; never restate it here. It is a **default, not a mandate**: a project
whose target surface is genuinely narrower says so once, in
