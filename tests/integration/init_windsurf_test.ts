...
Deno.test("specnaut init --ai windsurf scaffolds a Windsurf layout", async () => {
  await withTempDir(async (parent) => {
    ...
    // #322) = 54 (specnaut-auto removed in #409; merge-squash #558 + epic-commits #556 + quality-gates #555 + epic-fixups #559 + merge-close #560 added). code-audit's scope script
