...
**Rationale**: This is exactly the mechanism proven in the source `the reference project` system
...
- *A new bespoke frontmatter field (e.g. `contracts:`)* — rejected: `skills:` is the established
  Claude Code preload field and what the reference project uses; inventing a parallel field adds surface for no gain.
